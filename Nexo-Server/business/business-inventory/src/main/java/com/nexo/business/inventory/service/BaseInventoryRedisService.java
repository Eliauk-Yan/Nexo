package com.nexo.business.inventory.service;
...
/**
 * @classname BaseInventoryRedisService
 * @description Redis库存服务模板类
 * @date 2026/02/09 03:18
 */
@Slf4j
@RequiredArgsConstructor
public abstract class BaseInventoryRedisService {
