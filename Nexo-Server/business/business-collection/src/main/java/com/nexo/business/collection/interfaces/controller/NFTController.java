...
public class NFTController {
    ...
    public MultiResult<NFTVO> getNFTList(NFTPageQueryDTO queryDTO) {
        PageResponse<NFT> nftPageResponse = NFTService.pageQueryByState(NFTState.SUCCESS.getCode(), queryDTO.getKeyword(), queryDTO.getCurrentPage(), queryDTO.getPageSize());
